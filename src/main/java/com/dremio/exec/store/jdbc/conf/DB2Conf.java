...
@SourceType(value = "DB2ARP", label = "DB2",uiConfig = "db2-layout.json")
public class DB2Conf extends AbstractArpConf<DB2Conf> {
  private static final String ARP_FILENAME = "arp/implementation/db2-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.db2.DB2Driver";
